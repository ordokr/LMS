...
use crate::pages::quiz::{QuizPage, QuizListPage};
    ...
    view! {
        ...
        <Router>
            <Routes>
                ...
                <Route path="/quizzes" view=QuizListPage />
                <Route path="/quizzes/:id" view=QuizPage />
    ...
    view! { cx,
        <div class="container">
            ...
            <div class="actions">
                ...
                <a href="/quizzes" class="button">"Quizzes"</a>
            </div>
...
fn app_routes() -> Vec<RouteDef> {
    vec![
        ...
        RouteDef::new("/quizzes/:id")
            .component(move |cx| {
                let params = use_params_map(cx);
                let quiz_id = params.get("id").cloned().unwrap_or_default();
